                  ...
                  <Card key={comic.id}>
                    <div className="stack">
                      ...
                      <div className="kpi-label">
                        Автор: {comic.author?.creatorNick || comic.authorName} · Рейтинг: {Number(comic.rating).toFixed(1)} ({comic.ratingCount}) · Чтений: {comic.readCount} · Сцен: {comic.totalPages} · {new Date(comic.createdAt).toLocaleDateString('ru-RU')}
                      </div>
                      <div className="cluster">
