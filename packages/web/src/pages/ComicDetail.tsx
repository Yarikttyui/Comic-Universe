...
import { BookOpen, Clock3, Flag, GitBranch, LogIn, MessageSquare, Star } from 'lucide-react';
...
export default function ComicDetail() {
  ...
  const load = async (targetPage = 1) => {
    ...
    try {
      ...
      const rawComic = comicResponse.data.data.comic;
      setComic({
        ...rawComic,
      ...
      setPage(commentsResponse.data.meta?.page || targetPage);
      setTotalPages(commentsResponse.data.meta?.totalPages || 1);
    } catch (err: any) {
